...
public:
	...
	{
		JDBObject* JDBObjectNew = addPacket(stringa);
		JDBObjectNew->name = name;
		//length += name.length();
		namedLength += name.length();
	 ...
	 * Add a string property to an Object
	 */
	JDBObject* addPacket(string stringa)
	{
		JDBObject* JDBObjectNew = new JDBObject();
		JDBObjectNew->name = "";
	 ...
	 * Add a string property to an Object
	 */
	JDBObject* addPacket(char stringa[])
	{
		JDBObject* JDBObjectNew = new JDBObject();
		JDBObjectNew->name = "";
	...
	{
		JDBObject* JDBObjectNew = addPacket(boole);
		JDBObjectNew->name = name;
		//length += name.length();
		namedLength += name.length();
		JDBObjectNew->namedLength += name.length();
	 ...
	 * Add a bool  property to an Object
	 */
	JDBObject* addPacket(bool boole)
	{
		JDBObject* JDBObjectNew = new JDBObject();
	...
	JDBObject* addPacket(char value, char type)
	{
		JDBObject* JDBObjectNew = new JDBObject();
		JDBObjectNew->type = type;
		JDBObjectNew->name = "";
	 ...
	 * Add a double property to an Object
	 */
	JDBObject* addPacket(float doub)
	{
		JDBObject* JDBObjectNew = new JDBObject();
	 ...
	 * Add a double property to an Object
	 */
	JDBObject* addPacket(double doub)
	{
		JDBObject* JDBObjectNew = new JDBObject();
		JDBObjectNew->type = DOUBLE_FLOAT_TYPE;
		JDBObjectNew->name = "";
	 ...
	 * Add an integer property to an Object
	 */
	JDBObject* addPacket(int integer)
	{
		JDBObject* JDBObjectNew = new JDBObject();
		if(integer<256)
		{
	 ...
	 */
	void addPacket(JDBObject *packet)
	{
	...
	vector<JDBObject*> getPackets()
	{
		return packets;
	}
	void setPackets(vector<JDBObject*> packets)
	{
	...
	void addStaticPacket(JDBObject *obj)
	{
