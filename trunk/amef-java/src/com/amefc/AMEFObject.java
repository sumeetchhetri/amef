...
public final class AMEFObject
{
	...
	public AMEFObject addPacket(String string)
	{
		...
		AMEFObjectNew.value = string.toCharArray();
		packets.add(AMEFObjectNew);
	 ...
	 * Add a String property to an Object
	 */
	public void addPacket(char[] string,String name)
	{
		AMEFObject AMEFObjectNew = addPacket(string);
		AMEFObjectNew.name = name;
		//length += name.length();
	 ...
	 * Add a String property to an Object
	 */
	public AMEFObject addPacket(char[] string)
	{
		AMEFObject AMEFObjectNew = new AMEFObject();		
		AMEFObjectNew.name = "";
	...
	public AMEFObject addPacket(boolean bool)
	{
		...
		if(bool==true)
		{			
			AMEFObjectNew.value = new char[]{'1'};
		}
		else
		{
			AMEFObjectNew.value = new char[]{'0'};		
		}		
		packets.add(AMEFObjectNew);
		length += 2;
		namedLength += 4;
	...
	public AMEFObject addPacket(char chr)
	{
		...
		AMEFObjectNew.name = "";
		AMEFObjectNew.length = 1;
		AMEFObjectNew.value = new char[]{(char)chr};	
		packets.add(AMEFObjectNew);
		length += 2;
		namedLength += 4;
		AMEFObjectNew.namedLength = 2;
	...
	public AMEFObject addPacket(float doub)
	{
		...
		AMEFObjectNew.value = String.valueOf(doub).toCharArray();
		packets.add(AMEFObjectNew);
	...
	public AMEFObject addPacket(Date date)
	{
		...
		AMEFObjectNew.value = format.format(date).toCharArray();
	 ...
	 * Add a AMEFObjectNew property to an Object
	 */
	public void addPacket(char[] packet,char type)
	{
