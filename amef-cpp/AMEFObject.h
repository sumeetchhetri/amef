...
class AMEFObject
{
	...
	static map<char, string> typeMap;
...
public:
	...
	static const char NULL_NUMBER;

	static const char NULL_DATE;

	static const char NULL_FPN;

	static const char NULL_BOOL;

	static const char NULL_CHAR;

	static const char NULL_OBJECT;

	static const char INT_TYPE;

	static const char LONG_INT_TYPE;

	static const char BOOLEAN_TYPE;

	static const char CHAR_TYPE;

	static const char DATE_TYPE;

	static const char DOUBLE_FLOAT_TYPE;

	static const char ASCII_STRING_TYPE;

	static const char STRING_TYPE;

	static const char OBJECT_TYPE;

	static const char ASCII_STRING_TYPE_L;

	static const char STRING_TYPE_L;
