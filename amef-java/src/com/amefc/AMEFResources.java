...
public final class AMEFResources
{
	...
	public static char[] longToByteArray(long l,int ind) 
	{
	...
	public static char[] intToByteArray(int l,int ind) 
	{
		char[] result = new char[ind];
		for (int i = 0; i<ind; i++)
		{
	...
	public static char[] intToByteArrayWI(int l) 
	{
		int ind = 1;
		if(l<256)
			ind =1;
	...
	public static int byteArrayToInt(char[] l) 
	{
		int t = 0;
		int ind = l.length;
	...
	public static int byteArrayToInt(char[] l,int off,int ind) 
	{
		int t = 0;
		for (int i = 0; i < ind; i++)
		{
	...
	public static long byteArrayToLong(char[] l) 
	{
		long t = 0;
		int ind = l.length;
        for (int i = 0; i < l.length; i++)
	...
	public static long byteArrayToLong(char[] l,int off,int ind) 
	{
		long t = 0;
		for (int i = 0; i < ind; i++)
		{
	...
	public static long byteArrayToLong(char[] l,int ind) 
	{
		long t = 0;
		for (int i = 0; i < ind; i++)
		{
